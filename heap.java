...
class Entry
{
    ...
    public int value;//This denotes the value of the entry stored at the node
    // public int max=0;
...
public class heap
{
	 final int MAX_HEAP_SIZE = 1001;//This indicates the maximum size the heap can grow into.
    ...
    // public void modifyKeyOfNode(int k ,int v)
    // {
    //     int i;
    //     i=returnIndex(v);
    ...
    public int  getParticipant(int k)
        {
            return(A[k].value);
        }
